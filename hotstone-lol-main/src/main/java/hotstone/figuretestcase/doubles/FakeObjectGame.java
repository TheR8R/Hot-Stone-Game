...
import hotstone.framework.variants.AbstractFactory;
...
public class FakeObjectGame implements Game, MutableGame {
  ...
  public FakeObjectGame() {
    findusHand.add(0, new StubCard(GameConstants.BEEF_BURGER_CARD, Player.FINDUS, 1,"Opp M: (+2,0)"));
